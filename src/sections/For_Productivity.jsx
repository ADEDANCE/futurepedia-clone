...
import { FaEye, FaMusic, FaUser, FaYoutube } from "react-icons/fa";
...
import { forcreators1 } from "../assets/index";

const For_Productivity = () => {
  return (
        ...
        <div className=" grid grid-cols-1  lg:grid-cols-2 items-start  md:gap-20 p-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-7">
              ...
              <VideoCard image={forcreators1} />
              <VideoCard image={forcreators1} hidden="hidden sm:block" />
              <VideoCard image={forcreators1} hidden="hidden sm:block" />
            </div>
          </div>
        </div>
...
export default For_Productivity;
